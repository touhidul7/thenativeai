    ...
    <>
      ...
      <Section bordered={false}>
        <p className="max-w-3xl text-lg text-ink-muted">
          Our companies maintain their own brands, leadership, expertise and customer relationships. They
          are connected by a common operating philosophy and a shared platform designed to support growth,
          improve delivery and transfer knowledge.
        </p>

        <div className="mt-16 space-y-px overflow-hidden rounded-2xl border border-hairline bg-hairline">
          {companies.map((c) => (
            <article key={c.slug} className="grid gap-8 bg-background p-8 md:grid-cols-[1fr_2fr] md:p-12">
              <div>
              ...
              <div>
                ...
                <p className="mt-6 text-xs uppercase tracking-widest text-ink-muted">Core capabilities</p>
      ...
      <section className="container-page py-24 md:py-32">
        ...
        <p className="mt-6 max-w-2xl text-lg text-ink-muted">
          We partner with founders who want to preserve what they have built while creating a stronger path
          forward.
        </p>
        <div className="mt-10">
